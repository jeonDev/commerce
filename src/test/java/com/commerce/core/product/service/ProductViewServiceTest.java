...
class ProductViewServiceTest {
    ...
    void 상품등록동기화_성공() {
        // given
        ProductEventRequest request = new ProductEventRequest(1L, ProductViewStatus.REGISTER);
    ...
    void 상품재고동기화_성공() {
        // given
        ProductEventRequest request = new ProductEventRequest(1L, ProductViewStatus.STOCK_ADJUSTMENT);
